...
import { useGetVehiclesQuery } from "../services/starWarsApi";
...
function Vehicles() {
  ...
  return (
    ...
    >
        ...
        {Vehicles?.results?.map(({name, cargo_capacity,  crew, consumables,  cost_in_credits, length, passengers, model, max_atmosphering_speed, manufacturer}: any, index: any) => (
